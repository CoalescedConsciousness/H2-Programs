...
namespace Common
{
    public static class Database
    {
        ...
        // ConnectionString needed for, well, connecting to the (locally stored) permanent database.
        // Note: If you use a "VS external" database, e.g. a (PostGre) SQL server via pgAdmin, you'll need to use the library: Npgsql.
        ...
        /// <summary>
        /// Method for streamlining the process of querying the SQL database (connect, query, disconnect)
        /// </summary>
